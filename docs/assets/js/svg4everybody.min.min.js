  ...
  function e(e, t) {
    if (t) {
      var n = !e.getAttribute("viewBox") && t.getAttribute("viewBox"),
        ...
        r = t.cloneNode(!0);
      for (n && e.setAttribute("viewBox", n); r.childNodes.length; )
        ...
        if (u && /svg/i.test(u.nodeName)) {
          ...
          if (o && (!a || a(c, u, n))) {
            var f = c.split("#"),
              m = f[0],
              g = f[1];
            if ((u.removeChild(n), m.length)) {
              var l = (d[m] = d[m] || new XMLHttpRequest());
              l.s || ((l.s = []), l.open("GET", m), l.send()),
                l.s.push([u, g]),
                t(l);
            } else e(u, document.getElementById(g));
          }
        }
      }
      s(i, 17);
